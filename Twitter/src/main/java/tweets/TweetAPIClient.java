...
public class TweetAPIClient extends TwitterAPIClient {
    ...
    private final String CREATE_TWEET_ENDPOINT = "/statuses/update.json";//api
    private final String DELETE_TWEET_ENDPOINT = "/statuses/destroy.json";//api
    private final String GET_USER_TWEETS_ENDPOINT = "/statuses/user_timeline.json";//api
